...
Check out
[program repository](https://github.com/gemachain/gemachain-program-library/tree/master/token-swap)
...
[JavaScript
bindings](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/js/src/index.ts)
...
[end-to-end tests](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/js/cli/token-swap-test.ts).
...
that implements the
[CurveCalculator](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/calculator.rs)
...
curve](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/constant_product.rs)
...
The [constant price curve](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/constant_price.rs)
...
The [stable curve](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/stable.rs)
...
The [offset curve](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/offset.rs)
...
[curves](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/constant_product.rs)
and
[math](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/src/curve/math.rs)
...
tests](https://github.com/gemachain/gemachain-program-library/blob/master/token-swap/program/fuzz/src/instructions.rs)
of the repo.
